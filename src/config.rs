...
pub fn get_server() -> String {
    unsafe {
        ...
        if server_ptr.is_null() {
            ...
            CStr::from_ptr(server_ptr).to_string_lossy().into_owned()
        }
    }
}
...
pub fn get_user_agent() -> String {
    unsafe {
        ...
        if agent_ptr.is_null() {
            ...
            CStr::from_ptr(agent_ptr).to_string_lossy().into_owned()
        }
    }
}
...
mod tests {
    ...
    fn test_server_configuration() {
        ...
        assert!(
            current_server.contains("test.example.com"),
            "Expected server to contain 'test.example.com', got: {}",
            current_server
        );
    ...
    fn test_config_manager() {
...

        {
            let _config = CupsConfig::new()
                .with_server("managed.example.com")
                .unwrap()
