use cups_rs::get_destination;
use cups_rs::{COPIES, MEDIA, ORIENTATION, PRINT_COLOR_MODE, PRINT_QUALITY, SIDES};
use cups_rs::{MEDIA_A4, MEDIA_FLAGS_DEFAULT, MEDIA_LEGAL, MEDIA_LETTER};
